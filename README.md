...
| [`53. Jailbreak REWIND [Jetpack-Season 3 Update].rbxl`]() | 2019 | | Has jorzelekk's character model on top of a building. | Made by `@jorzelekk` |
| [`54. Jailbreak REWIND [Plane Update].rbxl`]() | 2019 | | Has jorzelekk's character model on top of a building. | Made by `@jorzelekk` |
| [`57. Jailbreak REWIND [Melee Weapon Update].rbxl`]() | 2019 | | Has jorzelekk's character model on top of a building. | Made by `@jorzelekk` |
| [`58. Jailbreak REWIND [3 Billion Update].rbxl`]() | 2019 | | Has jorzelekk's character model on top of a building. | Made by `@jorzelekk` |
| [`59. Jailbreak REWIND [Season 4 Update].rbxl`]() | 2019 | | Has jorzelekk's character model on top of a building. | Made by `@jorzelekk` |
| [`62. Jailbreak REWIND [HD Jetski Racing Update].rbxl`]() | 2020 | | Has jorzelekk's character model on top of a building. | Made by `@jorzelekk` |
| [`63. Jailbreak REWIND [Gun Skins Update].rbxl`]() | 2020 | | Has jorzelekk's character model on top of a building. | Made by `@jorzelekk` |
| [`64. Jailbreak REWIND [Flintlock Bonus Update].rbxl`]() | 2020 | | Has jorzelekk's character model on top of a building. | Made by `@jorzelekk` |
| [`65.. Jailbreak REWIND [2020 LIVE EVENT].rbxl`]() | 2020 | | Has jorzelekk's character model on top of a building. | Made by `@jorzelekk` |
